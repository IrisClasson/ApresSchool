-- Create challenges table for parent-kid challenges
...
CREATE INDEX IF NOT EXISTS idx_challenges_kid ON challenges(kid_id, status, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_challenges_parent ON challenges(parent_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_sessions_kid ON challenge_sessions(kid_id, completed_at DESC);
